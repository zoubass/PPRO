...
VALUES (NULL , 1, NULL, 'Strikac123', 'pass', 'Lukyn', 'Kebouz', 'lukyn@gmail.com', 0, 0, 777888999, DATE '1994-05-27', 1, 0);

INSERT INTO users (parent_id, reminder_id, ticket_id, userName, password, firstName, lastName, email, belt, stripes, tel, bornDate, role, enabled)
VALUES (NULL , NULL , 1, 'Mišánek', 'pass', 'Michal', 'Lapcaz', 'misanek@gmail.com', 0, 3, 111222333, DATE '1994-02-01', 0, 0);

INSERT INTO users (parent_id, reminder_id, ticket_id, userName, password, firstName, lastName, email, belt, stripes, tel, bornDate, role, enabled)
VALUES (1 , NULL , 2 , 'Dítě', 'pass', 'Josef', 'Smrádě', 'dite.com', 0, 1, 444555666, DATE '2008-12-24', 3, 0);

INSERT INTO users (parent_id, reminder_id, ticket_id, userName, password, firstName, lastName, email, belt, stripes, tel, bornDate, role, enabled)
VALUES (NULL , 2 , NULL , 'Ninja', 'pass', 'John', 'Smith', 'ninja@gmail.com', 3, 1, 222555888, DATE '1985-11-20', 2, 0);
-- endregion
...
-- region Attendance
INSERT INTO attendance(user_id, training_id, trainingDate)
VALUES (1, 1, DATE '2018-02-01');

INSERT INTO attendance(user_id, training_id, trainingDate)
VALUES (2, 1, DATE '2018-02-01');

INSERT INTO attendance(user_id, training_id, trainingDate)
VALUES (2, 2, DATE '2018-02-03');
