...
VALUES (0 , TIMESTAMP '2018-03-01' , TIMESTAMP '2017-10-01', 1);
...
VALUES (3, TIMESTAMP '2018-01-01');

INSERT INTO reminders(reminderCount, startingDate)
VALUES (1, TIMESTAMP '2018-01-27');
-- endregion
...
INSERT INTO trainings(title, beginning, ending, trainingLevel, coach, capacity, note)
VALUES ('Traning 4', TIMESTAMP '2018-02-02 19:30:00', TIMESTAMP '2018-02-02 21:00:00', 2, 'Jarda', 20, 'Open mat');
-- endregion
