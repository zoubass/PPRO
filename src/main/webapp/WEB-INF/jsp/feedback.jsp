            ...
            <li class="dropdown">
                ...
                <div class="dropdown-content">
                    ...
                    <sec:authorize access="hasRole('ROLE_ADMIN')">
                        ...
                        <a href="/feedbackList">Feedbacks</a>
                    </sec:authorize>
                </div>
            </li>
        </ul>
...
<div id="body">
    <div id="content">
        <div>
            <div>
                <h1>Nákupní košík</h1>
                <table title="Zpětná vazba od uživatelů" unless="${cart}==null">
                    <thead>
                    <tr>
                        <th>Autor hodnocení</th>
                        <th>Hodnocení</th>
                        <th>Komentář</th>
                        <th>Odebrat</th>
                    </tr>
                    ...
                    <c:forEach items="${feedbacks}" var="f">
                        <tr>
                            <td class="text-left">${f.authorEmail}</td>
                            <td class="text-left">${f.rating}</td>
                            <td class="text-left">${f.comment}</td>
                            <td class="text-left"><a href="/removeFeed?id=${f.id}">Odebrat</a></td>
                        </tr>
                    </c:forEach>
                    </tbody>
                </table>
